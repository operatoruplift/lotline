...
| Public homepage, Example and narrated films | Historically verified hosted; rechecked for this release | September 12 observations remain in [release verification](release-verification.md); current results, including the third controlled walkthrough, are in the [September 20 record](release-20260920.md) |
| Contribution planner on the public origin | Deployed and verified | Application release `bae159d`, deployment `dpl_4Q2kAnjTdDTsdYwidrkYgp93zgjy`, is READY; [hosted read-only evidence](releases/2026-09-20/hosted-live-smoke.json) verifies routes, 832 assets, balances, quote and units. Mainnet purchases remain unavailable. |
