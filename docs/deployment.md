...
| Public homepage, Example and narrated films | Historically verified hosted; rechecked for this release | September 12 observations remain in [release verification](release-verification.md); current results, including all five films, are in the [contribution release](contribution-release-20260920.md) |
| Contribution planner on the public origin | Deployed and verified | Application release `edbf36a`, deployment `dpl_AZ7Z5q5yL7Qn3hXDTb13soWYsqey`, is READY; [hosted read-only evidence](releases/2026-09-20/contribution-hosted-live.json) verifies routes, 832 assets, zero balances, quote and units. Mainnet purchases remain paused. |
