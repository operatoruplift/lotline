...
export default function DemoPage() {
  ...
  return <><SiteHeader /><main id="main" className="demo-page page-width">
    ...
    <section id="sponsor-demo" className="demo-technical" aria-labelledby="sponsor-demo-title">
      ...
      <p id="sponsor-demo-description" className="demo-intro">This narrated, captioned rehearsal follows a PreStocks contribution from asset selection to exact allocation, issuer verification and a shared plan. It then shows the Pyth reference status beside an xStocks estimate. Catalogs, estimates and the reference status are controlled fixtures, labeled throughout. No wallet connects and no funds move; the clip does not claim a live oracle observation or a price comparison.</p>
      <video controls playsInline preload="metadata" poster="/videos/release-20260921/sponsor-planning-poster.jpg" aria-label="Lotline PreStocks and Pyth controlled rehearsal" aria-describedby="sponsor-demo-description" data-demo-video="sponsor-planning" className="demo-video">
    ...
    <section id="controlled-demo" className="demo-technical" aria-labelledby="controlled-demo-title">
      ...
      <p id="controlled-demo-description" className="demo-intro">This narrated, 25-second recording shows the newer contribution flow running locally: exact review, separate receipts, recovery after an uncertain result, and a saved manual reminder. It uses a fake Wallet Standard wallet and mocked Jupiter and Solana responses. No funds moved. This is controlled test evidence of the review, recovery and receipt flow.</p>
      <p className="eyebrow">CONTROLLED WALKTHROUGH · 0:25 · NARRATED · NO FUNDS MOVED</p>
      <video controls playsInline preload="none" poster="/videos/release-20260919/execution-fixture-poster.png" aria-label="Lotline controlled contribution demonstration" aria-describedby="controlled-demo-description" data-demo-video="controlled" className="demo-video" style={{ aspectRatio: '36 / 25' }}>
        <source src="/videos/release-20260919/execution-fixture-walkthrough.mp4" type="video/mp4" /><track default kind="captions" src="/videos/release-20260919/execution-fixture-walkthrough.en.vtt" srcLang="en" label="English" />
