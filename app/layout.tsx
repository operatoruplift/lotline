...
import { MobileWalletSupport } from '@/components/mobile-wallet';
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en" data-scroll-behavior="smooth"><body><MotionProvider><a className="skip-link" href="#main">Skip to content</a>{children}<PwaSupport /><MobileWalletSupport /></MotionProvider></body></html>;
}
