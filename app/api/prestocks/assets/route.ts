...
export async function GET() {
  try {
    ...
    return Response.json({ state, assets: [], unavailable: [], message: safeMessage(error) }, { status: httpStatus(state), headers: noStore });
  }
}
