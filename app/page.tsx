...
export default function Home() {
  return <><SiteHeader /><LandingMotion><main id="main" className={styles.home} data-design="kova">
    <section className={styles.hero} data-scroll-scene aria-labelledby="hero-heading">
      <div className={styles.heroBackdrop} data-scroll-layer="54"><DecorativeVideo className={styles.heroFilm} src="/media/design/hero-boomerang.mp4" mobileSrc="/media/design/hero-boomerang-mobile.mp4" poster="/media/design/hero-poster.jpg" label="Hero boomerang" priority /></div>
      ...
      <div className={styles.previews} aria-label="Illustrative contribution plan">
        <Reveal className={styles.previewEntrance} delay={0}><div data-scroll-layer="18"><article className={`${styles.preview} ${styles.contribution}`} data-preview="contribution">
        ...
        <Reveal className={styles.previewEntrance} delay={80}><div data-scroll-layer="-12"><article className={`${styles.preview} ${styles.chosen}`} data-preview="split">
        ...
        <Reveal className={styles.previewEntrance} delay={160}><div data-scroll-layer="26"><article className={`${styles.preview} ${styles.detail}`} data-preview="detail">
    ...
    <section className={styles.features} id="features" aria-labelledby="features-heading">
      ...
      <div className={styles.featureGrid}>{features.map((feature, index) => <Reveal className={styles.featureWrap} delay={index * 90} key={feature.title}><article className={styles.feature} data-feature={index + 1} data-scroll-scene>
        <div className={styles.featureBackdrop} data-scroll-layer="22"><DecorativeVideo className={styles.featureFilm} src={`/media/design/${feature.media}.mp4`} poster={`/media/design/${feature.media}-poster.jpg`} label={feature.title} /></div>
    ...
    <section className={styles.how} aria-labelledby="how-heading">
      <Reveal><div className={styles.support} data-scroll-scene><div className={styles.supportFilm} data-scroll-layer="28"><DecorativeVideo src="/media/design/support.mp4" poster="/media/design/support-poster.jpg" label="A little room to think" /></div><p>A little room to think clearly.</p></div></Reveal>
  ...
  </main><SiteFooter immersive /></LandingMotion></>;
}
