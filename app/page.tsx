  ...
  return <><SiteHeader /><main id="main">
    <section className="hero page-width">
      <div className="hero-copy">
        <div className="eyebrow"><span className="eyebrow-rule" /> SMALL CONTRIBUTIONS. CLEAR INTENT.</div>
      ...
      <div className="hero-visual">
        ...
        <div className="product-preview" aria-label="Illustrative contribution plan">
    ...
    <section className="steps-section page-width">
      ...
      <div className="steps-grid">
        <article><span className="step-number">01</span><h3>Choose your split.</h3><p>Pick up to three verified xStocks. Set the percentages for your new contribution.</p></article>
        <article><span className="step-number">02</span><h3>See what adds up.</h3><p>Enter a USDC budget for quote estimates. Add a public wallet address to see your current units, too.</p></article>
        <article><span className="step-number">03</span><h3>Take the next step.</h3><p>Copy or export your plan. Open Jupiter to independently review amounts and fees before trading.</p></article>
      </div>
    </section>
