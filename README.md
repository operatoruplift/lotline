...
1. In an authorized target Supabase project, apply all three versioned migrations in timestamp order: shared provider limits, contribution plans, then expanded stock plans. With the Supabase CLI, link that project and run `supabase db push`.
